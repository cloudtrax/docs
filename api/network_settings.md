...
`after_splashpage_redirect_url` | string | The page to display after the splash page. Leave blank to display the client's requested page. <br/>:small_orange_diamond:Example value: `http://my-website.com` <br/>:small_orange_diamond:Allowed entry: `a valid URL` | none | optional
