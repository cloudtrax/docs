...
UAM splash pages are used to allow customers to host their own splash pages. This replaces the splash pages which are directly provided by each Open-Mesh router. The authentication is still done using the normal authentication backends. See  <a href='../../authentication/README.md'>Authentication Services</a>
